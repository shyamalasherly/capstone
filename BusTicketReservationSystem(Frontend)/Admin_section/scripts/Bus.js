...
function showData(data){
    ...
    let htmlData = data.map((el)=>getCard(el.busId,el.busName,el.driverName,el.busType,el.routeFrom,el.routeTo,el.arrivalTime,el.departureTime,el.seats,el.availableSeats,el.ticketCharges))
...
function getCard(id,BusName,DriverName,BusType,RouteFrom,RouteTo,ArrivalTime,DepartureTime,Seats,AvailableSeats,TicketCharges){
    ...
    <tr id=ID${id}>
        ...
        <td><input type="text" id="ticketCharges" value=${TicketCharges}  disabled></td>
